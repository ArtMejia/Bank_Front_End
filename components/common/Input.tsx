...
interface InputProps {
  ...
  id: string,
  type?: string,
  placeholder?: string, // adds text to the field itself. If you don't label prop make sure to use this.
  onChange: ChangeEventHandler,
  required?: boolean,
  value?: any, // required if type is not "file".
  accept?: string, // used by input type of "file"
  multiple?: boolean, // used by input type of "file"
  disabled?: boolean,
  label?: boolean, // will add text label above the input field.
  className?: string,
